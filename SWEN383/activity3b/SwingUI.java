...
public class SwingUI extends JFrame implements Observer {
    ...
    private JLabel FahrenheitField;	//put current fahrenhiet reading here
    private JLabel mbarField;		//put current millibar reading here
    private JLabel inchField;		//put current inch reading here
    /*
     * A Font object contains information on the font to be used to
     * render text.
     */
    private static Font labelFont =
        new Font(Font.SERIF, Font.PLAIN, 30) ;
    ...
    public SwingUI(WeatherStation station) {
        ...
        /*
         * Set up Pressure in Inch display.
         */
        panel = new JPanel(new GridLayout(2,1)) ;
        this.add(panel) ;
        createLabel(" Inches ", panel) ;
        inchField = createLabel("", panel) ;
        
        /*
         * Set up Pressure in mbar display.
         */
        panel = new JPanel(new GridLayout(2,1)) ;
        this.add(panel) ;
     ...
     */
    public void setInchPressureJLabel(double pressure){
    	inchField.setText(String.format("%6.2f", pressure ));
    }
    
    /*
     * Set the label holding the Pressure in millibar.
     */
    public void setmbarPressureJLabel(double pressure){
    	mbarField.setText(String.format("%6.2f", pressure ));
    }
	...
	public void update(Observable o, Object arg) {
    	...
    	this.setInchPressureJLabel(station.getInchPressure());
    	this.setmbarPressureJLabel(station.getmBarPressure());
